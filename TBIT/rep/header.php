...
<nav class="navbar is-white" role="navigation" aria-label="main navigation">
  <div class="navbar-brand">
    <a class="navbar-item" href="index.php?vista=menu">
    ...
    <div id="navMenu" class="navbar-menu">
      ...
      <div class="navbar-end">
        <div class="navbar-item">
          ...
          <a class="icon has-text-black mr-3" href="#"><i class="fa-solid fa-user"></i></a>
          <a class="icon has-text-black" href="./php/logout.php" onclick="return confirm('¿Estás seguro de que quieres cerrar sesión?');"><i class="fa-solid fa-sign-out-alt"></i></a>
        </div>
      </div>
    </div>
</nav>
